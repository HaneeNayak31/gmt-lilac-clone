...
const HeroBlog = () => {
  return (
    <section className="pt-20 lg:pt-30 w-full bg-[var(--color-background)] text-[var(--color-text-primary)] pb-[100px] px-6 font-[var(--font-gopher)]">
      <div className="mx-auto max-w-[1420px] grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-8 xl:gap-0">
        ...
        <div className="relative w-[85vw] max-w-[470px] aspect-[3/4] mx-auto md:mr-6 xl:mr-0 md:ml-10 xl:ml-25 animate-in fade-in slide-in-from-bottom-8 duration-[800ms] fill-mode-forwards" style={{ animationDelay: '0.1s' }}>
             <Image
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left md:pl-4 xl:pl-0">
          <h1 
            className="text-[40px] md:text-[45px] xl:text-[75px] font-medium leading-[1.1] mb-10 animate-in fade-in slide-in-from-bottom-8 duration-[800ms] fill-mode-forwards"
